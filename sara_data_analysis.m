...
[ax, fig] = gastric.plotISITriggeredBy(data, 'PD', 'LG_burst_starts',4, 3);

fig.OuterPosition = [300 300 1000 1201];
fig.PaperSize = [1000 1201];
...
[ax, fig] = gastric.plotISITriggeredBy(data, 'PD', 'LG_burst_ends',4, 3);
fig.OuterPosition = [300 300 1000 1201];
fig.PaperSize = [1000 1201];
